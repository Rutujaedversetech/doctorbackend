...
const LinkItems= [
  ...
  { name: "Timeline", icon: FiTrendingUp, url: "/patient/timeline" },
  { name: 'Clinical Summary', icon: MdNoteAdd, url: "/patient/clinic" },
...
>
  ...
  {isCollapsed ? <ChevronRightIcon /> : <ChevronDownIcon />}
                     ...
                     >
                      ...
                      <Link to='/doctor/contacts'><Text color={''}>{link.name}</Text></Link>
